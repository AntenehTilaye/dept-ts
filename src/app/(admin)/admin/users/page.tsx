...
export default async function UsersPage(props: PageProps<"/admin/users">) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader title="Users" description="Accounts, department memberships and invitations." />
            ...
            <CardContent>
              ...
              >
                ...
                <div className="grid gap-2">
                  ...
                  <NativeSelect id="departmentId" name="departmentId" required defaultValue="">
