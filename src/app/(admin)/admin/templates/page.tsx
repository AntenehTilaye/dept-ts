...
export default async function TemplatesPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="Templates"
        description="Notification and email templates with versions; departments can override faculty defaults."
      />
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Faculty templates and department overrides. Bodies are mustache with declared
              variables.
            </CardDescription>
          </CardHeader>
          <CardContent>
