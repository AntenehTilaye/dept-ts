...
export default async function AuditPage(props: PageProps<"/admin/audit">) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="Audit trail"
        description="Every write, transition, login and privileged action across the faculty. Filter by department, subject, action or actor."
      />
      <Card>
        <CardHeader>
          ...
          <form method="get" className="grid gap-2 md:grid-cols-5">
            ...
            <Button type="submit" variant="outline" className="md:col-start-5">
              Filter
            </Button>
          </form>
        </CardHeader>
