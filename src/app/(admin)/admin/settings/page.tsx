  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        description="Typed settings by scope; department values override faculty defaults."
      />
      <div className="flex flex-col gap-6">
        <form method="get" className="flex flex-wrap items-end gap-3">
          <div className="grid gap-1">
            <Label htmlFor="scope">Scope</Label>
            <NativeSelect id="scope" name="scope" defaultValue={scope} className="w-40">
          ...
          <div className="grid gap-1">
            ...
            <NativeSelect id="scopeId" name="scopeId" defaultValue={scopeId} className="w-56">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="grid gap-1">
                  ...
                  <NativeSelect id="new-scope" name="scope" defaultValue={scope}>
                    <option value="global">global</option>
                    <option value="department">department</option>
                    <option value="program">program</option>
                  </NativeSelect>
